            ...
            <div id="content">
                ...
                <section>
                    <div class="ramkaImg" style="flex: 1;">
                        <img src="img/band.jpg" alt="Telefon"/>
                    </div>
                    <div class="ramkaArticle" style="flex: 3;">
                        <article>
                            <form method="POST">
                                Email:<br/><input type="mail" name="email" required/>
                                <br/>Login:<br/><input type="text" name="login" required/>
                                <br/>Hasło:<br/><input type="password" name="password" required/>
                                <br/>Powtórz hasło:<br/><input type="password" name="rPassword" required/>
                                <br/></br><input type="submit" value="Zarejestruj się"/>
                            </form>
                            <br/><br/>
                            <a href="/login">Lub zaloguj się</a>
